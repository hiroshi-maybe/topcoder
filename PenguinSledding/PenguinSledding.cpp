...
/*
 ...
 14:51-15:41 give up and look at editorial. Ok I missed triangle case...
 
 http://apps.topcoder.com/wiki/display/tc/SRM+566
...
class PenguinSledding {
  ...
  long long countDesigns(int N, vector<int> C1, vector<int> C2) {
    ...
    REP(u,N) {
      ...
      REP(v,N) d+=mx[u][v];
      res+=1LL<<d;
      FOR(v,u+1,N)FOR(w,v+1,N) if(mx[u][v]&&mx[v][w]&&mx[w][u]) ++res;
    }
    res-=(N-1)+M;

...
/*
 ...
 8:17-8:20 system test passed (246.96 pt)
 
 editorial:
  - http://torus711.hatenablog.com/entry/20140927/1411815201
...
class MountainRanges {
  ...
  int countPeaks(vector<int> H) {
    int res=0,N=SZ(H);
    REP(i,N) {
      bool l=i==0||H[i]>H[i-1],r=i==N-1||H[i]>H[i+1];
      res+=(l&&r);
    }
    return res;
  }
...
// CUT begin
ifstream data("MountainRanges.sample");

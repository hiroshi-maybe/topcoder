...
/*
 ...
 8:21-8:42 system test passed (345.03 pt)
 
 editorial:
  - https://apps.topcoder.com/wiki/display/tc/SRM+634
  - http://torus711.hatenablog.com/entry/20140927/1411815200
  - http://kmjp.hatenablog.jp/entry/2014/09/27/0900
 
 24:20-24:24 add solution of @kmjp and official editorial
...
public:
  int minValue(int N, vector<int> s) {
    ...
    REP(n,N+1) {
      ...
      if((M-1)*nn>=left) return n;
    }
    return 0;
  }
};

class ShoppingSurveyDiv2_org {
  public:
  int minValue(int N, vector<int> s) {
    int M=SZ(s);

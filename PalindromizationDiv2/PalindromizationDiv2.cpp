...
/*
 ...
 8:25-8:30 ACC (241.99 pt)
 
 Editorials:
  - https://apps.topcoder.com/wiki/display/tc/SRM+509
  - http://d.hatena.ne.jp/kusano_prog/20110608/1307543661
  - http://purple-jwl.hatenablog.com/entry/20130329/1364549070
...
class PalindromizationDiv2 {
  ...
  int getMinimumCost(int X) {
    REPE(d,X) {
      int x1=X-d,x2=X+d;
//      dump4(x1,ok(x1),x2,ok(x2));
      if(ok(x1)||ok(x2)) return d;
    }
    return 0;
  }
};

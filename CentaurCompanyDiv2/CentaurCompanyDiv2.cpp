...
/*
 ...
 15:23-15:41 analysis
 15:42-15:50 system test passed (586.64 pt)
 
 Editorial:
  - https://apps.topcoder.com/wiki/display/tc/SRM+570
  - http://kmjp.hatenablog.jp/entry/2013/02/15/1000
  - https://topcoder.g.hatena.ne.jp/firewood/20130222/1361508122
  - http://ekaing.hatenablog.com/entry/2013/04/02/180925
 
 Key:
  - tree needs to be connected
  - typical tree DP
 
 Summary:
  - I missed to reset edges again 😵
...
class CentaurCompanyDiv2 {
  ...
  LL f(int u, int pre) {
    ...
    res=1LL;
    FORR(v,E[u]) if(v!=pre) res*=f(v,u)+1LL;
    ans+=res;
    return res;
  }

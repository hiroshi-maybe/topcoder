...
/**
 ...
 8:29-8:34 (242.59 pt) passed system test
...
class TestTaking {
  ...
  int findMax(int questions, int guessed, int actual) {
    int p1=guessed,p2=questions-guessed;
    int q1=actual,q2=questions-actual;
    return min(p1,q1)+min(p2,q2);
  }
};

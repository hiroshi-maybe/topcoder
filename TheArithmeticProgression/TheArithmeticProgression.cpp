...
/*
 ...
 8:17-8:24 system test passed (233.50 pt)
 ...
 Editorial:
  ...
  - http://torus711.hatenablog.com/entry/20130917/p3
  - https://topcoder.g.hatena.ne.jp/firewood/20131130/1385828062
 
 */
class TheArithmeticProgression {
  public:
  double minimumChange(int aa, int bb, int cc) {
    double a=aa,b=bb,c=cc;
//    dump2(fabs((c+a-2*b)/2.0),fabs(2*b-a-c));
    return min(fabs((c+a-2*b)/2.0),fabs(2*b-a-c));
  }
};

// CUT begin
ifstream data("TheArithmeticProgression.sample");
...
bool do_test(int a, int b, int c, double __expected) {

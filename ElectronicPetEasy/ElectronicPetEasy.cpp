...
/*
 ...
 8:49-8:55 system test passed (238.38 pt)
 
 editorial:
  - https://topcoder.g.hatena.ne.jp/firewood/20150106/1420560761
...
class ElectronicPetEasy {
  public:
  const string ok="Easy",ng="Difficult";
  string isDifficult(int st1, int p1, int t1, int st2, int p2, int t2) {
    SETI s1;
    for(int i=st1; i<st1+p1*t1; i+=p1) s1.emplace(i);
    for(int i=st2; i<st2+p2*t2; i+=p2) if (s1.count(i)) return ng;

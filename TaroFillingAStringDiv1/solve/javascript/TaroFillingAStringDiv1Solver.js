...
function main() { try {
    ...
    var position = reader.next("int[]"); reader.next();
    var value = reader.next("String");

    var TaroFillingAStringDiv1 = require("./TaroFillingAStringDiv1");
    var result = TaroFillingAStringDiv1.getNumber(N, position, value);

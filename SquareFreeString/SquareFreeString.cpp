...
/**
 ...
 19:37 read editorials
 - https://apps.topcoder.com/wiki/display/tc/SRM+701
 
 19:48 add another solution with inline checking without substring
 */
  ...
  string isSquareFree(string s) {
    ...
    REP(i,N) {
      for(int l=1; l<=N-i; ++l) {
        ...
        string tt1=t.substr(0,l/2), tt2=t.substr(l/2,l/2);
        if (tt1==tt2) return "not square-free";
      }
    }
    return "square-free";
  }

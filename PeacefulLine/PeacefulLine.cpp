...
/*
 ...
 20:10-20:17 system test passed
 
 if freq(i)>ceil(N/2), impossible
 
 editorial:
 - https://apps.topcoder.com/wiki/display/tc/SRM+647
 - http://torus711.hatenablog.com/entry/20150130/1422634069
...
public:
  string makeLine(vector<int> x) {
    ...
    for(auto &n : x) {
      ++F[n];
      if(F[n]>(N+1)/2) return "impossible";
    }
    return "possible";
  }
};
...
// CUT begin
ifstream data("PeacefulLine.sample");

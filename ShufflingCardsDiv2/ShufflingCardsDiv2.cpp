...
/*
 ...
 8:50-9:12 design
 9:12-9:15 implemented and system test passed (555.14 pt)
 
 editorial:
  - http://kmjp.hatenablog.jp/entry/2014/12/15/1030
  - http://ch.nicovideo.jp/yoshiki_utakata/blomaga/ar684564
 
 summary:
  - analysis problem
  - it would be greater if I analyzed faster
...
class ShufflingCardsDiv2 {
  ...
  string shuffle(vector<int> P) {
    ...
    int cnt=0;
    for(int i=0; i<2*N; i+=2) if(P[i]>N) ++cnt;
    return cnt==N/2?yes:no;
  }
};
...
int main(int argc, char *argv[]) {
    ...
    if (mainProcess) {
        cout << "ShufflingCardsDiv2 (900 Points)" << endl << endl;
    }

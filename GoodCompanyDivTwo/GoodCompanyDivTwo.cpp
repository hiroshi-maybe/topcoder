...
/*
 ...
 9:04-9:23 system test passed (182.59 pt)
 
 editorial:
  - https://apps.topcoder.com/wiki/display/tc/SRM+619
  - http://torus711.hatenablog.com/entry/20140505/1399309270
...
class GoodCompanyDivTwo {
  ...
  int countGood(vector<int> S, vector<int> W) {
    ...
    FORR(kvp,M) {
      bool ok=true;
      FORR(w,kvp.second) if(w.second>1) ok=false;
      res+=ok;
    }
    return res;
  }

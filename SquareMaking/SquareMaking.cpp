...
/*
 ...
 14:21-14:27 passed system tests
 
 https://www.topcoder.com/blog/single-round-match-711-editorials/
 
 17:01 add brute-force solution in editorial
...
public:
  int getMinimalPrice(int a, int b, int c, int d) {
    ...
    FOR(k,1,1000001) {
      res = min(res, abs(a-k)+abs(b-k)+abs(c-k)+abs(d-k));
    }
    return res;
  }
};

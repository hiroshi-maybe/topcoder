...
/**
 ...
 9:18-9:23 passed system test (241.34 pt)
...
bool do_test(vector<int> a, vector<int> b, int __expected) {
    ...
    Cdgame *instance = new Cdgame();
    int __result = instance->rescount(a, b);
...
int main(int argc, char *argv[]) {
    ...
    if (mainProcess) {
        cout << "Cdgame (250 Points)" << endl << endl;
    }

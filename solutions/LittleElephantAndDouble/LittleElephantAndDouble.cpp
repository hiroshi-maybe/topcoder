...
/*
 ...
 17:00-17:05 system test passed (243.96 pt)
 
 Edtorial:
  - https://apps.topcoder.com/wiki/display/tc/SRM+597
  - http://torus711.hatenablog.com/entry/20131120/p2
...
class LittleElephantAndDouble {
  ...
  string getAnswer(vector<int> A) {
    ...
    return SZ(S)==1?yes:no;
  }
};

// CUT begin
ifstream data("LittleElephantAndDouble.sample");

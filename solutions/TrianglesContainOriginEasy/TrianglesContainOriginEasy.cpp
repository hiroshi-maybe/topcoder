...
/*
 ...
 8:34-8:45 system test passed (427.62 pt)
 
 editorial:
  - http://kmjp.hatenablog.jp/entry/2014/12/15/1000
 
 key:
  - use cross product or polar angle
  - brute force of tuple of three points
 
 summary:
  - solved quickly this time. previously it took more time to solve geometric problem with cross product 👍
...
class TrianglesContainOriginEasy {
  ...
  int count(vector<int> X, vector<int> Y) {
    ...
    REP(i,N) FOR(j,i+1,N) FOR(k,j+1,N) {
      ...
      int d1=det(x1,y1,x2,y2)>0,d2=det(x2,y2,x3,y3)>0,d3=det(x3,y3,x1,y1)>0;
      res+=d1==d2&&d2==d3&&d3==d1;
    }
    return res;
  }
};

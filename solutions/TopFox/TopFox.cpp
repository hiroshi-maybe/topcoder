...
/*
 ...
 9:06-9:11 system test passed (242.66 pt)
 
 Edotorial:
  - https://apps.topcoder.com/wiki/display/tc/SRM+584
  - http://torus711.hatenablog.com/entry/20130710/p2
  - http://emkcsharp.hatenablog.com/entry/SRM584/TopFox
  - https://topcoder.g.hatena.ne.jp/firewood/20130726/1374859460
 
 */
class TopFox {
  public:
  int possibleHandles(string s1, string s2) {
    unordered_set<string> S;
    FOR(a,1,SZ(s1)+1)FOR(b,1,SZ(s2)+1) {
      S.emplace(s1.substr(0,a)+s2.substr(0,b));
    }
    return SZ(S);
  }
};

...
// CUT begin
ifstream data("WarmupWithRooks.sample");
...
bool do_test(vector<string> board, int __expected) {
    ...
    WarmupWithRooks *instance = new WarmupWithRooks();
...
int main(int argc, char *argv[]) {
    ...
    if (mainProcess) {
        cout << "WarmupWithRooks (200 Points)" << endl << endl;
    }

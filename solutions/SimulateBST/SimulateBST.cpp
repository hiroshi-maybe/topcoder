...
/*
 ...
 http://kmjp.hatenablog.jp/entry/2019/02/12/0900
...
//    dumpc(S);
    ModInt res;
    REP(i,N) {
      ModInt pow(10); pow=pow.pow(5*i);
      res+=ModInt(D[S[i]])*pow;
    }
    return res.val;
  }
};

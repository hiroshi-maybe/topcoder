...
/*
 ...
 16:11-16:17 passed system test (239.49 pt)
 
 editorial:
  - http://torus711.hatenablog.com/entry/20140111/p2
  - https://apps.topcoder.com/wiki/display/tc/SRM+604
 
 */
class FoxAndWord {
  public:
  int howManyPairs(vector<string> ws) {
    int res=0;
    int N=SZ(ws);
    REP(j,N)REP(i,j) {
      string s=ws[i],t=ws[j];
      bool ok=false;
      FOR(i,1,SZ(s)) {

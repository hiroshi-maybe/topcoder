...
/*
 ...
 8:28-8:44 system test passed (388.34 pt)
 
 P1(A): Generate permutation of sequence
 P2(A,B): Compute ∑ max(A[i],B[i])
 
 T(P1)=10!≈4*10^6
 T(P2)=10
 
 T(P1(A))*T(P1(B))*T(P2)=2*10^14>10^9.
 
 Actually we don't need to solve both P1 twice
 because permutation of A does not affect result of P2(A,B).
 
 P = P1(A)*P2(A,B)*P3(N), P3: computation of N!
 T(P)=T(P1)*T(P2)*T(P3)=10!*10*10≈4*10^8
 
 Editorial:
  - https://apps.topcoder.com/wiki/display/tc/SRM+592
  - http://torus711.hatenablog.com/entry/20130927/p2

...
/*
 ...
 Thus res=2^(n-1) as seen in @kmjp's solution
...
bool do_test(int n, long long __expected) {
    ...
    Chains1 *instance = new Chains1();
    long long __result = instance->countMaximalChains(n);
...
int main(int argc, char *argv[]) {
    ...
    if (mainProcess) {
        cout << "Chains1 (300 Points)" << endl << endl;
    }

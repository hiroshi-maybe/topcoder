...
/*
 ...
 8:51-8:55 system test passed (244.20 pt)
...
// CUT begin
ifstream data("LISNumberDivTwo.sample");
...
bool do_test(vector<int> seq, int __expected) {
    ...
    int __result = instance->calculate(seq);
...
int main(int argc, char *argv[]) {
    ...
    if (mainProcess) {
        cout << "LISNumberDivTwo (250 Points)" << endl << endl;
    }

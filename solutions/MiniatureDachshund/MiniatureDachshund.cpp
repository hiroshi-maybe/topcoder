...
/*
 ...
 19:26-19:35 system test passed (226.14 pt)
 
 Editorial:
  - http://topcoder.g.hatena.ne.jp/evima/20131210/1386698305
   - https://twitter.com/evima0/status/408292879824457731
  - https://apps.topcoder.com/wiki/display/tc/SRM+599
  - http://torus711.hatenablog.com/entry/20131204/p3
 
 */
class MiniatureDachshund {
  public:
  int maxMikan(vector<int> X, int x) {
    sort(X.begin(),X.end());
    int i=0;
    int N=SZ(X);
    while(i<N&&x<=5000) {

...
/*
 ...
 14:46-14:56 AC (221.51 pt)
 
 http://apps.topcoder.com/wiki/display/tc/SRM+435
...
class CellRemoval {
  ...
  int cellsLeft(vector<int> P, int v0) {
    REP(i,51)E[i].clear();
    N=SZ(P),this->v0=v0;
    int root=-1;
    REP(i,N) {
...
// CUT begin
ifstream data("CellRemoval.sample");
...
int main(int argc, char *argv[]) {
    ...
    if (mainProcess) {
        cout << "CellRemoval (250 Points)" << endl << endl;
    }

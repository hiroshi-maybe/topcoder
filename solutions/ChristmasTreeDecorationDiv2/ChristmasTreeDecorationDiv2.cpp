...
/*
 ...
 8:22-8:28 system test passed (238.87 pt)
...
// CUT begin
ifstream data("ChristmasTreeDecorationDiv2.sample");
...
bool do_test(vector<int> col, vector<int> x, vector<int> y, int __expected) {
    ...
    ChristmasTreeDecorationDiv2 *instance = new ChristmasTreeDecorationDiv2();
...
int main(int argc, char *argv[]) {
    ...
    if (mainProcess) {
        cout << "ChristmasTreeDecorationDiv2 (250 Points)" << endl << endl;
    }

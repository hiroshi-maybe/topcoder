...
class CalkinWilfReversed {
  ...
  long long getDepth(long long a, long long b) {
    ...
    return b/a+getDepth(a,b%a);
  }
};

// CUT begin
ifstream data("CalkinWilfReversed.sample");
...
bool do_test(long long a, long long b, long long __expected) {
    ...
    CalkinWilfReversed *instance = new CalkinWilfReversed();
    long long __result = instance->getDepth(a, b);
...
int main(int argc, char *argv[]) {
    ...
    if (mainProcess) {
        cout << "CalkinWilfReversed (500 Points)" << endl << endl;
    }

...
/*
 ...
 8:19-8:41 system test passed (166.55 pt)
...
class Target {
  ...
  vector<string> draw(int N) {
    ...
    REP(n,K) {
      int x=2*n,l=N-2*x;
      FOR(i,x,x+l) res[i][x]=res[i][N-x-1]='#';
      FOR(j,x,x+l) res[x][j]=res[N-x-1][j]='#';
    }

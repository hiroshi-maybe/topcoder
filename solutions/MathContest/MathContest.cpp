...
/*
 ...
 16:21-16:35 analysis
 16:36-16:39 implement and ACC (377.67 pt)
 
 Editorials:
  - https://apps.topcoder.com/wiki/display/tc/SRM+504
  - http://d.hatena.ne.jp/kusano_prog/20110426/1303847042
  - http://kg86.hatenablog.com/entry/20130627/1372343719
  - http://d.hatena.ne.jp/michey1001/touch/20110429/1304096164
 
 */
class MathContest {
  public:
  int countBlack(string S, int R) {
    deque<int> Q;
    REP(i,R) REP(j,SZ(S)) Q.push_back(S[j]=='B');
    
    int res=0;
    bool s=1,fr=1;
    while(SZ(Q)) {
      int x=fr?Q.front():Q.back();
      if(fr) Q.pop_front();
      else Q.pop_back();

...
/*
 ...
 9:21-10:18 got AC after contest ended
 
 http://kmjp.hatenablog.jp/entry/2019/04/21/0900
...
class EllysTicketPrices {
  ...
  bool ok(LL p0) {
    ...
    LL p=p0;
    REP(i,N-1) {
      LL pp=10LL*p*(100+C[i])/100;
      pp=round(pp);
      pp/=10;
//      dump(i,p);
      res+=pp,p=pp;
      if(res>1000LL*N*T) return false;
    }
    //    dump(p,res);
    res*=10;
    res/=N;

...
/*
 ...
 10:35-10:39 system test passed (240.68 pt)
 
 Editorial:
  - https://apps.topcoder.com/wiki/display/tc/SRM+563
  - http://kmjp.hatenablog.jp/entry/2012/12/09/0930
  - http://purple-jwl.hatenablog.com/entry/20130120/1358700381
  - http://d.hatena.ne.jp/kusano_prog/20121209/1355066398
...
class FoxAndHandleEasy {
  ...
  string isPossible(string S, string T) {
    REP(i,SZ(S)+1) {
      string s=S.substr(0,i)+S+S.substr(i);
//      dump2(i,s);
      if(s==T) return yes;
    }
    return no;
...
// CUT begin
ifstream data("FoxAndHandleEasy.sample");

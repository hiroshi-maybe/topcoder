...
class Cross {
  ...
  string ok = "Exist";
  string ng = "Does not exist";
};

// CUT begin
ifstream data("Cross.sample");
...
bool do_test(vector<string> board, string __expected) {
    ...
    string __result = instance->exist(board);
...
int main(int argc, char *argv[]) {
    ...
    if (mainProcess) {
        cout << "Cross (250 Points)" << endl << endl;
    }

...
/*
 ...
 8:53-9:03 system test passed (222.54 pt)
 
 editorial:
  - https://apps.topcoder.com/wiki/display/tc/SRM+611
  - http://torus711.hatenablog.com/entry/20140305/p4
...
class InterestingNumber {
  ...
  string isInteresting(string X) {
    REP(i,10) {
      if(count(X.begin(),X.end(),'0'+i)==0) continue;
      if(count(X.begin(),X.end(),'0'+i)!=2) return no;
      int l=0;
      while(X[l]!='0'+i) ++l;
      int r=l+1;
      while(X[r]!='0'+i) ++r;
      if(r-l-1!=i) return no;
    }

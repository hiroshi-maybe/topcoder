...
/*
 ...
 8:14-8:18 System test passed (245.16 pt)
 
 Editorials:
  - https://apps.topcoder.com/wiki/display/tc/SRM+542
  - http://topcoder.g.hatena.ne.jp/agw/20120523/1337744656
  - http://kg86.hatenablog.com/entry/20130723/1374556020
...
class WorkingRabbits {
  ...
  double getEfficiency(vector<string> P) {
    ...
    int cnt=0;
    double res=0;
    REP(j,N)REP(i,j) res+=P[i][j]-'0',++cnt;
    return res/cnt;
  }
};

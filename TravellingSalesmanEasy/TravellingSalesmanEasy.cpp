...
/*
 ...
 20:19-20:31 system test passed
 
 editorial:
 - http://torus711.hatenablog.com/entry/20150130/1422634068
 - http://kmjp.hatenablog.jp/entry/2015/01/26/0930
...
public:
  int getMaxProfit(int M, vector<int> P, vector<int> C, vector<int> S) {
    ...
    REP(i,M+1) sort(I[i].begin(),I[i].end());
